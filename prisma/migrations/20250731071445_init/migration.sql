...
CREATE TABLE `Machine` (
    ...
    `type` ENUM('ICE_CREAM_MACHINE', 'SUGARCANE_JUICE_MACHINE', 'COFFEE_TEA_MACHINE', 'PIZZA_OVEN', 'POPCORN_MACHINE', 'HOT_BEVERAGE_VENDING_MACHINE', 'SWEET_CORN_MACHINE', 'WAFFLE_MAKER', 'STAINLESS_STEEL_DEEP_FRYER', 'FOOD_WARMER', 'JUICER_MACHINE', 'JUICE_DISPENSER', 'BAKERY_MACHINE', 'BAKERY_EQUIPMENT', 'COMMERCIAL_FOOD_PROCESSING_MACHINE', 'FAST_FOOD_KITCHEN_EQUIPMENT', 'HOTEL_SUPPLY', 'ACCESSORY', 'MACHINE_SPARE', 'MISCELLANEOUS') NOT NULL,
...
CREATE TABLE `CommonSpecs` (
    ...
    `capacityLiters` VARCHAR(191) NULL,
    `capacityKg` VARCHAR(191) NULL,
    `numberOfShelves` VARCHAR(191) NULL,
    `traySize` VARCHAR(191) NULL,
    `compatibleAccessories` VARCHAR(191) NULL,
    `mountingType` VARCHAR(191) NULL,
    `insulationType` VARCHAR(191) NULL,
    `controlType` VARCHAR(191) NULL,
    `safetyFeatures` VARCHAR(191) NULL,
